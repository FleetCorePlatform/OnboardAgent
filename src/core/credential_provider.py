...
class CredentialProvider:
    def __init__(self, cert_path: str, key_path: str, ca_path: str, role_alias: str,
                 thing_name: str) -> None:
    ...
    def get_credentials(self) -> CredentialsModel:
        ...
        if self._current_credentials is None:
            ...
            expiry = datetime.fromisoformat(self._current_credentials.expiration.replace('Z', '+00:00'))
